...
const (
	...
	ChatService_SendServiceMessage_FullMethodName   = "/webitel.chat.server.ChatService/SendServiceMessage"
...
type ChatServiceClient interface {
	...
	SendServiceMessage(ctx context.Context, in *SendServiceMessageRequest, opts ...grpc.CallOption) (*SendServiceMessageResponse, error)
	// API /v1
...
func (c *chatServiceClient) SendServiceMessage(ctx context.Context, in *SendServiceMessageRequest, opts ...grpc.CallOption) (*SendServiceMessageResponse, error) {
	out := new(SendServiceMessageResponse)
	err := c.cc.Invoke(ctx, ChatService_SendServiceMessage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedChatServiceServer) SendServiceMessage(context.Context, *SendServiceMessageRequest) (*SendServiceMessageResponse, error) {
...
func _ChatService_SendServiceMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendServiceMessageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServiceServer).SendServiceMessage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatService_SendServiceMessage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).SendServiceMessage(ctx, req.(*SendServiceMessageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ChatService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ChatService_SendServiceMessage_Handler,
		},
		{
