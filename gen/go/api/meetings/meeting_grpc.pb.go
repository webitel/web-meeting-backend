...
const (
	MeetingService_CreateMeeting_FullMethodName = "/meetings.MeetingService/CreateMeeting"
	MeetingService_GetMeeting_FullMethodName    = "/meetings.MeetingService/GetMeeting"
	MeetingService_GetMeetingNA_FullMethodName  = "/meetings.MeetingService/GetMeetingNA"
)
...
func (c *meetingServiceClient) GetMeetingNA(ctx context.Context, in *GetMeetingRequest, opts ...grpc.CallOption) (*Meeting, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Meeting)
	err := c.cc.Invoke(ctx, MeetingService_GetMeetingNA_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var MeetingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "meetings.MeetingService",
